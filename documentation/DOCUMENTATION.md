...
```
www/
├── config.php                  ← Secrets (NOT in version control)
...
├── sc_data_cache.json          ← SC cache file (auto-generated, 5 min TTL)
├── sck_data_cache.json         ← SCK cache file (auto-generated, 5 min TTL)
├── pa_data_cache.json          ← PA cache file (auto-generated, 15 min TTL)
├── cz_sensors.json             ← Supplementary sensor data
├── cache/
